class ImpressumDialog extends BaseDialog {
  ...
  getContent() {
    ...
    <p><b>Critical</b>Bikes is an open source project from Studies For Future Augsburg, licensed under the <a target="_blank" rel="noopener" href="https://www.gnu.org/licenses/agpl-3.0.html">AGPLv3 License</a>. The source code can be found
